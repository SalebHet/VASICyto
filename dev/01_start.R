...
golem::fill_desc(
  pkg_name = "VASICyto", # The Name of the package containing the App 
  pkg_title = "VASICyto", # The Title of the package containing the App 
  pkg_description = "PKG_DESC.", # The Description of the package containing the App 
  author_first_name = "Clément", # Your First Name
  author_last_name = "Nerestan",  # Your Last Name
  author_email = "clement.nerestan@u-bordeaux.fr",      # Your Email
  repo_url = "https://github.com/SalebHet/VASICyto.git" # The (optional) URL of the GitHub Repo
)     
...
usethis::use_data_raw( name = "CellPop", open = FALSE ) # Change "my_dataset"
